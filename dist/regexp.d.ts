 ...
 */
export declare const RegExpRungDateStrict: RegExp;
/**
 * 中国省
 *
 * @example
 * 浙江,台湾
 */
export declare const RegProvince: RegExp;
/**
 ...
 * 匹配中文汉字以及中文标点符号 。 ？ ！ ， 、 ； ： “ ” ‘ ' （ ） 《 》 〈 〉 【 】 『 』 「 」 ﹃ ﹄ 〔 〕 … — ～ ﹏ ￥
 */
export declare const RegExpCNPunctuation: RegExp;
/**
 * qq号格式正确
 *
 * @example
 ...
 * 1.23,-1.01
 */
export declare const RegExpFloatingNumberStrict: RegExp;
/**
 * email(支持中文邮箱)
 *
 * @example
 ...
 */
export declare const RegDomainName: RegExp;
/**
 * 军官/士兵证
 *
 * @example
 ...
 */
export declare const RegMilitaryCertificate: RegExp;
/**
 * 户口薄
 *
 * @example
 * 441421999707223115
 */
export declare const RegAccountBook: RegExp;
