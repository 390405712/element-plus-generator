        ...
        return delete e.model, delete e.formOption, a.formOption.forEach((c) => {
          ...
          default: () => [a.formOption.map((c) => {
            ...
            if (!(c.hasOwnProperty("show") && c.show === !1))
              return l(p, c.formItem, Te(t = $(c)) ? t : {
                default: () => [t]
              });
          }), e.disabled === !0 || e.noFooter || !e.onSubmit ? "" : l(p, {
